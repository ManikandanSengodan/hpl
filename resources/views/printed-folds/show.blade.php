                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <a href="{{ route('printed-folds.edit', $fold->id) }}" class="btn bg-gradient-warning btn-md mr-2">{{ __('Edit') }}</a>
                                ...
                                <a href="{{ route('printed-folds.index') }}" class="btn bg-gradient-primary btn-md mr-2 float-right">{{ __('Back') }}</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
