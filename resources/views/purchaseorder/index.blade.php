            ...
            <div class="row justify-content-center">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Woven Purchase Order</h3>
                        <div class="float-right">
                            <a href="{{ route('purchaseorder.create') }}" class="btn bg-gradient-primary float-right">Add Purchase Order</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @forelse ($purchaseOrders as $purchaseOrder)
                                    <tr>
                                        ...
                                        <td>{{ $purchaseOrder->designCard ? ucwords($purchaseOrder->designCard->label) : '-'}}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('purchaseorder.show',$purchaseOrder->id) }}" class="btn btn-sm btn-warning">View</a>
                                            
                                            <a href="{{ route('purchaseorder.edit',$purchaseOrder->id) }}" class="btn btn-sm btn-info">Edit</a>
