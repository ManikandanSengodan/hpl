                    ...
                    <div class="card card-primary" style="width: 850px;">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                ...
                                <a href="{{ route('folds.show', $fold->id) }}" class="btn bg-gradient-primary btn-md mr-2">{{ __('Cancel') }}</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" id="submit_form" action="{{ route('folds.update', $fold->id) }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
