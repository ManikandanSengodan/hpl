...
@section('title', 'Edit Loom Operator')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('Edit Loom Operator - ') . $loomoperator->name }}</h1>
        </div>
        <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary" style="width: 850px;">
                        <div class="card-header">
                            <h3 class="card-title">Edit Loom Operator</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('loomoperators.update', $loomoperator->id) }}" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="card-body row">
                               ...
                               <div class="col-md-6" style=""> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{$loomoperator->name}}" placeholder="Name">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{$loomoperator->email}}" placeholder="Email">
                                    @error('email')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{$loomoperator->phone}}" placeholder="Mobile No">
                                    @error('phone')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('qualification') is-invalid @enderror" id="qualification" value="{{$loomoperator->qualification}}" name="qualification" placeholder="Qualification">
                                    @error('qualification')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('b_group') is-invalid @enderror" id="b_group" value="{{$loomoperator->blood_group}}" name="blood_group" placeholder="Blood group">
                                    @error('b_group')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
