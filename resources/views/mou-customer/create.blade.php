...
@section('content_header')
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <a href="{{ route('customermou.index') }}" class="btn bg-gradient-primary float-right">Back</a>
        </div>
    </div>
@stop
            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary" style="width: 850px;" >
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('customermou.store') }}" enctype="multipart/form-data" novalidate>
                            @csrf
