                    ...
                    <div class="card card-primary" >
                        ...
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                @if($editdesignCard)
                                    <a href="{{ route('woven.show',$editdesignCard->id) }}" class="btn bg-gradient-primary mr-3">View</a>
                                @endif
                                <a href="{{ route('woven.index') }}" class="btn bg-gradient-primary btn-md mr-2">Back</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
