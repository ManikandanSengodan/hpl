...
@section('title', 'Printed Design Card')
            ...
            <div class="row justify-content-center">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Printed Design Card</h3>
                        <div class="float-right">
                            <a href="{{ route('printed.create') }}" class="btn bg-gradient-primary float-right">Add Printed Design Card</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @forelse ($wovens as $woven)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('printed.show',$woven->id) }}" class="btn btn-sm btn-warning">View</a>
                                            
                                            <a href="{{ route('printed.edit',$woven->id) }}" class="btn btn-sm btn-info">Edit</a>
                                            <form method="POST" action="{{ route('printed.destroy', $woven->id) }}"
